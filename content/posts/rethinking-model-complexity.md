...
\log p(D_n)
\approx
\log p(D_n \mid \hat{\theta}) - \tfrac{1}{2} \log \det H_n + O(1).
$$
...
\log p(D_n)
\approx
\log p(D_n \mid \hat{\theta}) - \frac{d}{2} \log n + O(1),
$$
...
- kalyaan rao, "[evidence slopes and effective dimension in singular linear models](https://arxiv.org/abs/2411.19920)," preprint
